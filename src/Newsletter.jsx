    ...
    <div>
      {form ? (
        ...
        <div className="box-message">
          <img className="icon-success" src="src/assets/icon-success.svg" alt="icon success"></img>
          <h1>Thanks for subscribing!</h1>
          <p className="msg">
            A confirmation email has been sent to <span>{email}</span>. Please open it and click
